   ...
   return (
      <>
         ...
         <div className="benefits-list">
            <h3 className="font-bolder">Try <span className="text-gradient">Caffino</span> and start ...</h3>
            <p>✅ Tracking your coffee consumption</p>
            <p>✅ Measuring your blood caffeine levels</p>
            <p>✅ Costing and quantiting your addiction</p>
         </div>
